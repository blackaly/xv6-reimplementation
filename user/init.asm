...
main(void)
{
  ...
  6e:	86e50513          	addi	a0,a0,-1938 # 8d8 <malloc+0x13c>
  ...
  8c:	7f850513          	addi	a0,a0,2040 # 880 <malloc+0xe4>
  90:	00000097          	auipc	ra,0x0
  94:	31e080e7          	jalr	798(ra) # 3ae <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00000517          	auipc	a0,0x0
  9e:	7e650513          	addi	a0,a0,2022 # 880 <malloc+0xe4>
  a2:	00000097          	auipc	ra,0x0
  a6:	304080e7          	jalr	772(ra) # 3a6 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00000517          	auipc	a0,0x0
  b0:	7f450513          	addi	a0,a0,2036 # 8a0 <malloc+0x104>
  ...
  ca:	85258593          	addi	a1,a1,-1966 # 918 <argv>
  ce:	00000517          	auipc	a0,0x0
  d2:	7ea50513          	addi	a0,a0,2026 # 8b8 <malloc+0x11c>
  d6:	00000097          	auipc	ra,0x0
  da:	2c8080e7          	jalr	712(ra) # 39e <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7e250513          	addi	a0,a0,2018 # 8c0 <malloc+0x124>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51a:	3eab8b93          	addi	s7,s7,1002 # 900 <digits>
 ...
 65a:	2a290913          	addi	s2,s2,674 # 8f8 <malloc+0x15c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 722:	20a7b783          	ld	a5,522(a5) # 928 <freep>
 ...
 750:	00e6ea63          	bltu	a3,a4,764 <free+0x50>
{
 ...
 792:	18f73d23          	sd	a5,410(a4) # 928 <freep>
}
 796:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c4:	16853503          	ld	a0,360(a0) # 928 <freep>
 ...
 7ec:	14090913          	addi	s2,s2,320 # 928 <freep>
  if(p == (char*)-1)
 7f0:	5afd                	li	s5,-1
 7f2:	a88d                	j	864 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7f4:	00000797          	auipc	a5,0x0
 7f8:	13c78793          	addi	a5,a5,316 # 930 <base>
 7fc:	00000717          	auipc	a4,0x0
 800:	12f73623          	sd	a5,300(a4) # 928 <freep>
 804:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 826:	10a73323          	sd	a0,262(a4) # 928 <freep>
      return (void*)(p + 1);
